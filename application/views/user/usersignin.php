...
<!-- [ auth-signin ] start -->
<section>
 <form class="row g-3 needs-validation" method='post' action="<?=BASEURL?>user/signin"  method="POST" enctype="multipart/form-data">
			...
			<div class="row align-items-center ">
				<div class="col-md-12">
					<div class="card-body">
						...
						<hr>
						<div class="form-group mb-3" <?=form_error('Username')?>>
							<input type="text" class="form-control" name='username' id="Username" placeholder=" user name" required>
						</div>
						<div class="form-group mb-4" <?=form_error('pwd')?>>
						...
						<p class="mb-2 text-muted">Forgot password? <a href="auth-reset-password.php" class="f-w-400">Reset</a></p>
