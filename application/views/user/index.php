            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div><h5 class="m-b-10"><?php echo 'welcome  '. $this->session->userdata('username'); ?></h5> </div>
                        <div><h5 class="m-b-10"><?php echo 'Your Id is  '. $this->session->userdata('user_id'); ?></h5> </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Dashboard Analytics</a></li>
                        </ul>
                    </div>
<span><input type="text" readonly value="<?=BASEURL?>user/signup/<?=bin2hex($this->session->userdata('user_id'))?>" id='11'>

    <button type="button" onclick="myfunction()" class="btn btn-primary btn-sm">Copy URl</button><span>
...
<?php $aa=$this->db->select_sum('amount')->where('user_id',$this->session->userdata('user_id'))->where('status !=','Requested')->get('admin_request')->row()->amount+0;?>
<h1 class="text-c-yellow"><?="$".$aa?></h1>
</div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="<?=BASEURL?>/assets/images/user/avatar-4.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="<?=BASEURL?>/assets/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="<?=BASEURL?>/assets/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                                    <h6>William Jem</h6>
                        ...
                        <div class="review-block">
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="<?=BASEURL?>/assets/images/user/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="<?=BASEURL?>/assets/images/user/avatar-4.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row m-b-20 received-chat">
                            <div class="col-auto p-r-0">
                                <img src="<?=BASEURL?>/assets/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40">
                            </div>
                            <div class="col">
                                <div class="msg">
                        ...
                        <div class="row m-b-20 send-chat">
                            ...
                            <div class="col-auto p-l-0">
                                <img src="<?=BASEURL?>/assets/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40">
                            </div>
                        </div>
                        <div class="row m-b-20 received-chat">
                            <div class="col-auto p-r-0">
                            ...
                            <div class="col">
                                <div class="msg">
                                    <p class="m-b-0">Nice to meet you!</p>
                                    <img src="<?=BASEURL?>/assets/images/widget/dashborad-1.jpg" alt="">
                                    <img src="<?=BASEURL?>/assets/images/widget/dashborad-3.jpg" alt="">
                                </div>
                                <p class="text-muted m-b-0"><i class="fa fa-clock-o m-r-10"></i>10:20am</p>
                            </div>
                        </div>
